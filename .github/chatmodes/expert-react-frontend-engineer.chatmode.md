---
description: "Frontend engineer agent for the spring-batch-dashboard React + TypeScript + Vite SPA"
...
| `yarn lint`            | ESLint over the whole tree.                              |
| `yarn test`            | Vitest in watch mode.                                    |
| `yarn test:run`        | Vitest one-shot.                                         |
| `yarn test:coverage`   | Vitest + v8 coverage; enforces the 80% threshold.        |
